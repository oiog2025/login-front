...
import {UserUseCase} from './user-management/application/input/UserUseCase';
...
import {AuthUseCase} from './user-management/application/input/AuthUseCase';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // Cuando la vista pida AuthUseCase, el núcleo responde con el servicio de aplicación AuthService
